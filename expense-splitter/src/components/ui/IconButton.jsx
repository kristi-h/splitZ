...
export default function IconButton({children, icon}) {
  ...
  return (
        <button className='flex flex-col text-white rounded-lg w-[96px] h-[64px] py-[0.16rem] items-center mx-auto hover:bg-white hover:text-primary/90 transition-all'>
